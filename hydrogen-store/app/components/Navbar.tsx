      ...
      >
        <div className="grid grid-cols-3 items-center">
          ...
          >
            ...
            <span className={`transition-all leading-none text-2xl sm:text-3xl lg:text-4xl ${logoColor}`} style={{ fontFamily: "'Cormorant', serif", fontWeight: 300, letterSpacing: '0.22em' }}>
              APRICITY
            </span>
          </Link>
