  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed bottom-6 left-4 right-20 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 z-[9998] bg-white text-[#1a1a1a] shadow-2xl rounded-2xl py-4 px-6 items-center justify-center gap-3 cursor-pointer hover:shadow-xl transition-all sm:w-auto sm:max-w-xs${hideOnMobile ? ' hidden sm:flex' : ' flex'}`}
      >
