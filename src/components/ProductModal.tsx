...
export const ProductModal: React.FC<ProductModalProps> = ({ product, onClose, onAddToCart, formatPrice }) => {
  ...
  const parsedSections = useMemo(() => {
    ...
    const descFeaturesHtml = (product as any).descriptionFeaturesHtml;
    const attentionHtml = (product as any).attentionSeekersMetafield;
    const sizeFitHtml = (product as any).sizeFitMetafield;
    const careHtml = (product as any).careMetafield;
